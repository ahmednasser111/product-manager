...
import { useGetProductQuery } from "../app/Slices/ProductApiSlice";
...
export default function ProductDetails() {
	...
	if (isLoading) {
		return (
			<Flex minHeight="100vh" justify="center" align="center" bg={bgColor}>
				<Spinner size="xl" />
			</Flex>
		);
	}
		...
		<Box minHeight="100vh" bg={bgColor}>
			<Container maxW="6xl" py={12}>
				<Flex direction={{ base: "column", md: "row" }} gap={8}>
					...
					<VStack flex={1} align="start" spaceY={6}>
